...
- **Systematic review**: 73 studies synthesized on breaststroke energy cost determinants
- Three domains: kinematics, active drag, energetics
- Key kinematic variables: stroke rate, stroke length, stroke index, intra-cyclic velocity variations
- Arm-to-leg timing (coordination) significantly affects energy cost
- Breaststroke has higher active drag, frontal area, and energy cost vs other strokes
- Breaststroke maintains lower velocity than other techniques
- 1,464 articles identified → 201 eligible → 73 included